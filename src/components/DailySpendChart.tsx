...
export const DailySpendChart = (props: DailySpendChartProps) => {
  ...
  const barChartOptions = (): ApexOptions => ({
    ...
    colors: chartData().map(d => (d.amount > 1000000 || d.amount > props.dailyBudget()) ? '#EF4444' : '#52C278'),
      ...
      <div class="flex items-center justify-between mb-6 mx-3">
        ...
        <Tooltip content="Click to edit budget">
          <div 
            ...
            onClick={() => {
              const newBudget = prompt("Enter new daily budget:", props.dailyBudget().toString());
