...
import type { PendingBatchTransactionAction, PendingTransferAction } from "../../../types/intelligence";
...
const ChatPanel = () => {
  ...
  return (
    <div class="flex flex-col flex-1 min-h-0">
      <Show
        when={intelligenceState.pendingAction?.kind === "transaction-batch"}
        fallback={
          <>
            <div
              ref={scrollRef}
            ...
            <Show when={intelligenceState.pendingAction?.kind === "transfer"}>
              <PendingActionCard
                action={intelligenceState.pendingAction as PendingTransferAction}
