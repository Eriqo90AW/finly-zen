...
export const StockHero = (props: StockHeroProps) => {
  ...
  return (
    <div class="premium-card relative overflow-hidden p-4 sm:p-6 bg-gradient-to-br from-white via-sage/5 to-sage/10 border-forest/10 group transition-all duration-500 hover:shadow-lg hover:cursor-default">
      ...
      <div class="relative flex flex-col lg:flex-row justify-between items-start lg:items-end gap-4 sm:gap-6">
        ...
        <div class="flex flex-col gap-3 w-full lg:w-auto">
          <div class="flex flex-col gap-1">
            <div class="flex items-center gap-2 sm:gap-3 flex-wrap">
              ...
              >
                <span
                  class="material-icons text-lg sm:text-xl transition-transform"
                  classList={{
              ...
              <h1 class="text-2xl sm:text-3xl md:text-4xl font-cormorant font-bold text-forest leading-tight tracking-tight line-clamp-1">
                {d().company_name}
              </h1>
              <div class="flex items-center gap-1.5 sm:gap-2">
                <span class="bg-forest text-white text-[9px] sm:text-[10px] px-2 py-0.5 rounded-lg font-black tracking-widest shadow-sm">
                  {d().ticker}
                </span>
                <span class="bg-white/80 backdrop-blur-sm text-forest/60 text-[8px] sm:text-[9px] px-1.5 py-0.5 rounded-lg font-bold border border-forest/10 uppercase tracking-widest">
                  {d().exchange}
                </span>
              </div>
            </div>

            <div class="flex items-center gap-2 sm:gap-3 flex-wrap mt-0.5">
              <div class="flex gap-1.5 sm:gap-2 flex-wrap">
                <Show when={d().sector}>
                  <span class="bg-fin-blue/5 text-fin-blue text-[8px] sm:text-[9px] px-2 py-0.5 rounded-full font-bold border border-fin-blue/10 uppercase tracking-wide">
                    {d().sector}
                  </span>
                </Show>
                <Show when={d().industry}>
                  <span class="bg-fin-purple/5 text-fin-purple text-[8px] sm:text-[9px] px-2 py-0.5 rounded-full font-bold border border-fin-purple/10 uppercase tracking-wide">
                    {d().industry}
                  </span>
                </Show>
              </div>
              ...
              <div class="flex items-center gap-1.5 sm:gap-2 bg-white/40 backdrop-blur-md px-2.5 py-1 rounded-full border border-forest/5 shadow-sm group/status hover:bg-white/60 transition-all duration-300">
                <div
                  class={`w-1.5 h-1.5 rounded-full ${status().color} animate-pulse-soft`}
                ></div>
                <span class="text-[8px] sm:text-[9px] font-black text-forest uppercase tracking-tight whitespace-nowrap">
                  {status().session}
                </span>
                <span class="text-[8px] sm:text-[9px] text-earth/60 font-bold uppercase tracking-widest border-l border-forest/10 pl-2">
          ...
          <p class="text-[9px] sm:text-[10px] text-earth/60 font-bold uppercase tracking-[0.15em] mt-0.5">
            Last Updated •{" "}
        ...
        <div class="flex items-center gap-4 sm:gap-6 lg:gap-10 bg-forest/[0.02] p-3 sm:p-5 lg:p-4 rounded-2xl border border-forest/5 w-full lg:w-auto justify-between lg:justify-start">
          <div class="flex flex-col items-start">
            <div class="flex items-center gap-1.5 mb-1">
              <p class="text-[8px] sm:text-[9px] font-bold text-earth/60 uppercase tracking-widest">
                Price Action
              </p>
            ...
            <div class="flex items-center gap-3">
              <div class="flex flex-col items-start min-w-28 sm:min-w-32">
                <div class="flex items-center gap-2 sm:gap-3">
                  <span class="text-2xl sm:text-[34px] lg:text-[38px] font-outfit font-black text-forest leading-none tracking-tighter">
